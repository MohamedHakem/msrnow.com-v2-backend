  ...
  return (
    <div dir="rtl" className="flex flex-col overflow-hidden">
      <div className="flex flex-col overflow-hidden">
        <nav className="flex flex-row z-90 items-stretch h-16 border-b w-full">
          <Navbar />
        </nav>
        <main
          className="grid grid-cols-[1fr] w-full relative overflow-x-hidden overflow-y-auto h-[calc(100vh-64px-32px)]"
        >
          <section className="flex flex-row flex-auto h-[calc(100vh-64px-32px)]">
            <div className="flex flex-col flex-auto gap-2 max-w-5xl m-auto">
              {children}
            </div>
          </section>
        </main>
